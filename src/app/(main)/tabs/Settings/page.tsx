...
const SEttings = () => {
  ...
  return (
    ...
    <div className='m-6'>
      <div>
        <span className="p-4 font-bold dark:text-white">Personal</span>
      ...
      <div>
        <span className="p-4 font-bold dark:text-white ">Company</span>
        ...
        <div>
        <span className="p-4 font-bold dark:text-white">Display</span>
        <div className="grid grid-cols-4">
