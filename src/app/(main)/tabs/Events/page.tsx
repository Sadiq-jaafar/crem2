...
import { IoIosRefresh, IoIosShare, IoIosTrash } from "react-icons/io";
...
const Events = () => {
  ...
  const memos: Memo[] = [
    {
      id: '1',
           event: 'New neeting has been scheduled at Founting view estate, Gurara AA New sit',
  ...
  const sidebarItems = [
    { label: 'All Events', count: 199, active: true },
    { label: 'My Teams', count: 44 },
    { label: 'Drafts', count: 33 },
    { label: 'Ongoing', count: 10 },
    { label: 'Scheduled', count: 10 },
  ...
  return (
   <div className="h-[calc(100vh-48px)] relative flex flex-col bg-gray-100"> {/* Added pt-12 for header space */}
     
      {/* Fixed Sidebar */}
      <div className="w-[146px] flex flex-col items-center bg-gray-100 border-r-2 border-gray-200 pt-5 fixed h-full overflow-y-auto no-scrollbar">
        <Button 
          ...
          style={{ 
            ...
            <TableHeader className="sticky top-0 z-10 bg-gray-100">
              ...
              >
                ...
                <TableHead className="font-medium w-12 flex-none"></TableHead>
                <TableHead className="font-medium w-54 flex-none">Events</TableHead>
                
                <TableHead className="font-medium flex-1">Subjects</TableHead>
                <TableHead className="font-medium w-32 flex-none">Format</TableHead>
                <TableHead className="font-medium w-28 flex-none">Status</TableHead>
                <TableHead className="font-medium w-22 flex-none">Date</TableHead>
                <TableHead className="font-medium w-27 flex-none">Read Status</TableHead>
              </TableRow>
            </TableHeader>
              ...
              {memos.map((memo) => (
                ...
                >
                  ...
                  <TableCell className="w-12 flex-none">
                    <Image src={icons.bell} width={16} height={16} alt="Outgoing" />
                  </TableCell>
                  <TableCell className="text-sm w-54 flex-none whitespace-nowrap overflow-hidden text-ellipsis">{memo.event}</TableCell>
                 
                  <TableCell className="text-sm w-60 whitespace-nowrap overflow-hidden text-ellipsis">{memo.subject}</TableCell>
                  <TableCell className="text-sm w-32 flex-none whitespace-nowrap overflow-hidden text-ellipsis">{memo.format}</TableCell>

                  <TableCell className="text-sm w-28 flex-none whitespace-nowrap overflow-hidden text-ellipsis">
                    {memo.paymentStatus === 'not paid' && (
                      <span className="text-red-600 font-semibold">On Going</span>
                    )}
