...
function FeedCard() {
  return (
    <div
      className='hidden lg:flex fixed shadow-lg shadow-gray-600 border-gray-300 top-[25.5vh] 2xl:right-20 right-2 z-10 dark:border-gray-700 rounded-lg overflow-hidden flex-col w-[19%] h-[380px] transition-colors lg:w-40 xl:w-[19%] xl:h-[calc(100vh-30vh)] 2xl:w-[18%] 2xl:h-[calc(100vh-25.5px)] 2xl:text-3xl'
    >
